...
| T3 | **列追加・親リンク名寄せは完了 09-04**（migration 20260904100000）。残: バッジを `species_qualifier` 参照、`origin_type` 廃止、投稿フォームでの入力 | スキーマ Phase A | Claude Code | 9/14 | 系統図の前提 |
...
- **2026-09-04（同日追記）**: オーナー承認で Field Archive を本番反映。オーナー方針「開業届・PAY.JP より先にクオリティ」を受け、課金系 T4/T11 は後回し。T2 データ修正・スキーマ Phase A・人物ページ・系統図を同日デプロイ。
